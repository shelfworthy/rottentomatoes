...
class rtClassInitTest(unittest.TestCase):
    ...
    def test_uninitialized_api_key(self):
        self.assertEqual(RottenTomatoesClient().api_key, 'my_api_key')

    def test_initialized_api_key(self):
        self.assertEqual(RottenTomatoesClient('called_api_key').api_key, 'called_api_key')

    def test_version_argument_with_float(self):
        self.assertEqual(RottenTomatoesClient(version=2.5).version, '2.5')
...
class InfoMethodTest(unittest.TestCase):
    ...
    def test_empty_info_method_call_fails(self):
        self.assertRaises(TypeError, RottenTomatoesClient().info)
    ...
    def test_specific_info_for_reviews(self):
        fight_club = '13153'
        RottenTomatoesClient().info(fight_club, 'reviews')
        path = call_args('path')
...
class FeelingLuckyMethodTest(unittest.TestCase):
    ...
    def test_empty_feeling_lucky_method_fails(self):
        self.assertRaises(TypeError, RottenTomatoesClient().feeling_lucky)

    def test_first_json_loads_movies_result_is_returned(self):
        data = RottenTomatoesClient().feeling_lucky('some movie')
